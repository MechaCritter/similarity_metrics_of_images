...
\item \textbf{Normalization:} Normalize the resulting VLAD vector to enhance its robustness and improve similarity measurement during retrieval.
\item \textbf{Post-Processing:} Optionally, further process the VLAD vector using techniques such as dimensionality reduction or whitening depending on the application.
%\end{enumerate}
